" =============================================================================
" Filename: autoload/lightline/colorscheme/deus_conboy.vim
" ForkedFrom: https://github.com/itchyny/lightline.vim/blob/c5512fcc33cd9d0f04c9b6d88066b7909f94d277/autoload/lightline/colorscheme/deus.vim
" OriginalAuthor: nikersify (https://github.com/nikersify)
" Author: Dale Conboy
" License: MIT License
" =============================================================================
...
let s:p.normal.right = [ [ '#292c33', '#98c379', s:term_black, s:term_green, 'bold' ], [ '#98c379', '#292c33', s:term_green, s:term_black ] ]
...
let s:p.inactive.left = s:p.inactive.right[0:]
...
let g:lightline#colorscheme#deus_conboy#palette = lightline#colorscheme#fill(s:p)
